...
BOT_USERNAME = getenv("BOT_USERNAME", "VIP_X_MUSIC_BOT")
BOT_NAME = getenv("BOT_NAME", "Vip Music")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1003550365298))
...
# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/II_ADI_II")
